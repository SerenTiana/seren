...
function setup() {
  createCanvas(windowWidth, windowHeight); //fills screen on a wesbsite
  
  tposX = width/2 - tSize - 7
  tposY = height/2 - tSize/ 8

  textFont(font);

  let points = font.textToPoints("STAR", tposX, tposY, tSize, {
